...
- SDS遵循C字符串以空字符（'\0'）结尾的惯例，但是那1个字节不计算在len中。
...
- C语言如果要获取字符串的长度，需要从第一个字符开始，遍历整个字符串，直到遍历到 '\0' 符号，时间复杂度是O(N)，即字符串的长度。
...
- sds判断字符串结束，是通过len属性，而不是通过'\0'来判断。
...
#### 总结
<div align="center"> <img src="../pics//2019-04-14_083005.png" width="600"/> </div><br>
...
```
<div align="center"> <img src="../pics//2019-04-14_083941.png" width="600"/> </div><br>
...
```
<div align="center"> <img src="../pics//2019-04-14_084246.png" width="600"/> </div><br>
...
图示：
<div align="center"> <img src="../pics//20171030221435564.png" width="600"/> </div><br>
